...
if os.stat("result.log").st_size and not filecmp.cmp("result.log", "result.log.old"):
    ...
    content = "cat result.log | mail -s 'Google Escalation - New Cores Found' owenyang@juniper.net msanthanam@juniper.net harib@juniper.net bpchoi@juniper.net"
    # content = "cat result.log | mail -s 'Google Escalation - New Cores Found' owenyangg@juniper.net"
